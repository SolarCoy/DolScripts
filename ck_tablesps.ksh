...
#
#  Usage : ck_tablesps.ksh [%]  exmp. ck_tablesps.ksh 90  default is 85%
#
#  Author : Faying Dong
#
#  Date :  Dec. 05, 2005
...
export MAIL_SUBJ_TBLSPS_WAN="DB Tablespace Warning - ${HOST_NAME}"
export MAIL_SUBJ_TBLSPS_CRT="DB Tablespace Critical - ${HOST_NAME}"
